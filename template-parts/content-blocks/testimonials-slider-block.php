...
<section 
	class="testimonial-slider relative overflow-hidden bg-tertiary m-0! section-p-b section-p-t
	<?php 
				...
				?>
					<li class="splide__slide">
						<div class="p-6 lg:max-w-4xl mx-auto h-full flex items-center justify-center">
							<?php if( $testimonial ) { 
									echo '<blockquote class="bg-tertiary border-0 w-full text-center"><p class="text-light text-xl italic">'.$testimonial.'</p>'; 
