				...
				<div class="content-inner flex flex-col justify-center p-8 md:p-16 w-full lg:h-full">
					...
					<?php if( $button_link && $button_text ) {
						echo '
							...
							<svg id="Group_14" data-name="Group 14" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28.666" height="21.496" viewBox="0 0 28.666 21.496">
								<defs>
									<clipPath id="clip-path">
									<rect id="Rectangle_42" data-name="Rectangle 42" width="28.666" height="21.496" fill="#faf4e7"/>
									</clipPath>
								</defs>
