	...
	<div class="grid grid-flow-row grid-cols-12 gap-0">
		...
		?>
			...
			<div class="text-block col-span-12 lg:col-span-6 bg-primary text-white">
				<div class="content-inner flex flex-col justify-center p-8 md:p-16 lg:p-20 w-full lg:h-full">
					...
					<?php if( $button_link && $button_text ) {
						echo '
							<div class="mt-8 mb-4 flex"><a 
								...
								class="arrow-btn p-0 bg-transparent hover:bg-transparent text-white! hover:text-dark! flex items-center content-between !no-underline transition duration-200 ease-in-out text-nowrap"
