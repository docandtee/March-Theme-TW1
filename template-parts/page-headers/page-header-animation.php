...
<section class="page-header particles-bg relative overflow-hidden hero-height flex items-end justify-center" aria-label="animnated page header background">
        ...
        <div class="particle particle-1 absolute w-full h-full opacity-40"></div>
        <div class="particle particle-1b absolute w-full h-full opacity-40"></div>
        <div class="particle particle-2 absolute w-full h-full opacity-25"></div>
        <div class="particle particle-2b absolute w-full h-full opacity-25"></div>
        <div class="particle particle-3 absolute w-full h-full opacity-15"></div>
        <div class="particle particle-3b absolute w-full h-full opacity-15"></div>
